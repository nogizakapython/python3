...
#配列を定義する
array1 = ["大園玲","小坂菜緒","正源司陽子","守屋麗奈","佐々木久美","山下瞳月","山下葉留花","梅澤美波","筒井あやめ","遠藤さくら","中西アルノ","齊藤京子","井上和","山下美月","小林由依","山﨑天"]

array2 = ["好きな小説家","好きなお笑い芸人","好きなファッションブランド","好きなコスメブランド","好きな赤文字系ファッション雑誌","好きなロックバンド","住みたい街","好きなランニングシューズ","好きなおにぎりの具","納豆餅に使う納豆は小粒派、ひきわり派","スマートフォンはAndroid派？iPhone派？","一度は行きたい国","好きなゲーム","手軽にできる料理","初心者にお薦めのプログラミング言語","初詣でおみくじを引く?"]

#エクセルファイルのファイル名変数
out_file = "odai.xlsx"
#エクセルファイルをロードする。既に対象エクセルファイルが開いていたらメッセージを出力して処理を終了する。
try:
  wb = openpyxl.load_workbook(out_file)
  #書き込むワークシートを定義する
  ws = wb['select']
except PermissionError as e:
  #既にファイルが開いているときのメッセージ
  print(f"{out_file}ファイルが既に開いています。閉じて再実行してください")
  sys.exit()
